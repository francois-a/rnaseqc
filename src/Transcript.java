...
public class Transcript {
    ...
    public static void main(String[] args) {
        try{
            ...
            TranscriptList transcripts = TranscriptList.loadGTF("/Users/ddeluca/Documents/RNA-seq/metrics/test/chr18.gtf",null);//"/Users/ddeluca/Downloads/gencode.v7.annotation_goodContig.gtf",null);
...
//        exons.set(exonIndex,e);
    ...
    public static void transcriptsToRefGeneFile(ArrayList<String> orderedContigNames,ArrayList<Transcript> transcripts, String refGen) throws IOException{
        ...
        for (String contig: orderedContigNames){
            // for a contig, we mSAMPLEust first filter, sort and then output


            // first sort for the transcripts in this condig
            ...
            if (!contigHasTranscripts){
                //System.out.println("WARNING:\tContig named, '"+contig+"' had no transcripts in transcript definition file. ('"+contigAlt+"' was also not found)");
            }
...
//        int maxExons ;
//        if (this.exons.size() > t.exons.size()){
//            maxExons = this.exons.size();
//        }else{
//            maxExons = t.exons.size();
//        }
